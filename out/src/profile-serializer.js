...
const pprof_format_loader_1 = require("./pprof-format-loader");
const pprofFormat = (0, pprof_format_loader_1.loadPprofFormat)();
const { Function: PprofFunction, Label: PprofLabel, Line: PprofLine, Location: PprofLocation, Profile: PprofProfile, Sample: PprofSample, StringTable: PprofStringTable, ValueType: PprofValueType, } = pprofFormat;
